...
The opinions corpus currently contains **<!-- COUNT:opinions -->20,108<!-- /COUNT --> opinions** with **<!-- COUNT:citelinks -->127,225<!-- /COUNT --> citation links** between them, with per-release corrections summarized in the
...
|----------|--------|--------------------|
| `opinions.db`     | ND Supreme Court opinions (+ some Court of Appeals) | <!-- COUNT:opinions -->20,108<!-- /COUNT --> opinions, <!-- COUNT:citelinks -->127,225<!-- /COUNT --> citation links, 1889–present |
...
**<!-- COUNT:opinions -->20,108<!-- /COUNT --> opinions** (of which 80 are
