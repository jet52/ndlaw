...
The opinions corpus currently contains **<!-- COUNT:opinions -->20,098<!-- /COUNT --> opinions** with **<!-- COUNT:citelinks -->126,957<!-- /COUNT --> citation links** between them, with per-release corrections summarized in the
...
|----------|--------|--------------------|
| `opinions.db`     | ND Supreme Court opinions (+ some Court of Appeals) | <!-- COUNT:opinions -->20,098<!-- /COUNT --> opinions, <!-- COUNT:citelinks -->126,957<!-- /COUNT --> citation links, 1889–present |
...
the release notes for each published database version.
...
governing how West reporter entries are used for validation
without redistributing West editorial content.
